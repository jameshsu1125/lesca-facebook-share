  ...
  return I || (I = 1, function(o) {
    ...
    (function(b, a) {
      b(function() {
        ...
        e.FALLBACK_PHONE = "UnknownPhone", e.FALLBACK_TABLET = "UnknownTablet", e.FALLBACK_MOBILE = "UnknownMobile", G = "isArray" in Array ? Array.isArray : function(T) {
        ...
        function H(T, S) {
          ...
          if (!r || !S)
            return !1;
          for (i = S.toLowerCase(), n = 0; n < r; ++n)
            if (i === T[n].toLowerCase())
              return !0;
          return !1;
        }
        function A(T) {
          for (var S in T)
            M.call(T, S) && (T[S] = new RegExp(T[S], "i"));
        }
        function C(T) {
          return (T || "").substr(0, 500);
        }
        (function() {
          var S, i, n, r, s, B, t = e.mobileDetectRules;
          for (S in t.props)
            if (M.call(t.props, S)) {
              for (i = t.props[S], G(i) || (i = [i]), s = i.length, r = 0; r < s; ++r)
                n = i[r], B = n.indexOf("[VER]"), B >= 0 && (n = n.substring(0, B) + "([\\w._\\+]+)" + n.substring(B + 5)), i[r] = new RegExp(n, "i");
              t.props[S] = i;
            }
          A(t.oss), A(t.phones), A(t.tablets), A(t.uas), A(t.utils), t.oss0 = {
            WindowsPhoneOS: t.oss.WindowsPhoneOS,
            WindowsMobileOS: t.oss.WindowsMobileOS
          };
        })(), e.findMatch = function(T, S) {
          for (var i in T)
            if (M.call(T, i) && T[i].test(S))
              return i;
          return null;
        }, e.findMatches = function(T, S) {
          var i = [];
          for (var n in T)
            M.call(T, n) && T[n].test(S) && i.push(n);
          return i;
        }, e.getVersionStr = function(T, S) {
          var i = e.mobileDetectRules.props, n, r, s, B;
          if (M.call(i, T)) {
            for (n = i[T], s = n.length, r = 0; r < s; ++r)
              if (B = n[r].exec(S), B !== null)
                return B[1];
          }
          return null;
          ...
          if (T.mobile === a) {
            var n, r, s;
            if (r = e.findMatch(e.mobileDetectRules.tablets, S), r) {
              T.mobile = T.tablet = r, T.phone = null;
              return;
            }
            if (n = e.findMatch(e.mobileDetectRules.phones, S), n) {
              T.mobile = T.phone = n, T.tablet = null;
              return;
            }
            e.isMobileFallback(S) ? (s = l.isPhoneSized(i), s === a ? (T.mobile = e.FALLBACK_MOBILE, T.tablet = T.phone = null) : s ? (T.mobile = T.phone = e.FALLBACK_PHONE, T.tablet = null) : (T.mobile = T.tablet = e.FALLBACK_TABLET, T.phone = null)) : e.isTabletFallback(S) ? (T.mobile = T.tablet = e.FALLBACK_TABLET, T.phone = null) : T.mobile = T.tablet = T.phone = null;
          }
        ...
        function l(T, S) {
          this.ua = C(T), this._cache = {}, this.maxPhoneWidth = S || 600;
        }
        return l.prototype = {
          constructor: l,
          /**
           ...
           */
          userAgent: function() {
            return this._cache.userAgent === a && (this._cache.userAgent = e.findMatch(e.mobileDetectRules.uas, this.ua)), this._cache.userAgent;
          },
          /**
           ...
           */
          userAgents: function() {
            return this._cache.userAgents === a && (this._cache.userAgents = e.findMatches(e.mobileDetectRules.uas, this.ua)), this._cache.userAgents;
          },
          /**
           ...
           */
          os: function() {
            return this._cache.os === a && (this._cache.os = e.detectOS(this.ua)), this._cache.os;
          },
          /**
           ...
           */
          is: function(T) {
            return H(this.userAgents(), T) || P(T, this.os()) || P(T, this.phone()) || P(T, this.tablet()) || H(e.findMatches(e.mobileDetectRules.utils, this.ua), T);
          },
          /**
          ...
          isPhoneSized: function(T) {
            return l.isPhoneSized(T || this.maxPhoneWidth);
          },
          /**
          ...
          mobileGrade: function() {
            return this._cache.grade === a && (this._cache.grade = e.mobileGrade(this)), this._cache.grade;
          }
        }, typeof window < "u" && window.screen ? l.isPhoneSized = function(T) {
          return T < 0 ? a : e.getDeviceSmallerSide() <= T;
        } : l.isPhoneSized = function() {
        }, l._impl = e, l.version = "1.4.5 2021-03-13", l;
      });
    })(function(b) {
      if (o.exports)
        return function(a) {
...
var c = u();
const V = /* @__PURE__ */ D(c), N = () => {
  const o = navigator.userAgent || navigator.vendor || window.opera;
  return o.indexOf("FBAN") > -1 || o.indexOf("FBAV") > -1;
}, m = () => {
  const o = new V(window.navigator.userAgent);
  return o.tablet() || o.mobile() ? "mobile" : "desktop";
}, h = () => {
  const o = window.location.origin + window.location.pathname;
  if (o.indexOf(".") > 0) {
    const b = o.split("/");
    b.pop();
    const [a] = b.splice(0, 2);
    return `${a}//${b.join("/")}/`;
  }
  return o;
}, L = { v: "v20.0", onload: () => {
} }, d = { id: "" }, p = (o, b) => {
  const a = { ...L, ...b }, { onload: e, v: M } = a;
  d.id = o, window.fbAsyncInit = function() {
    window.FB.init({
      appId: o,
      cookie: !0,
      xfbml: !0,
    ...
    var A, C = G.getElementsByTagName(P)[0];
    G.getElementById(H) || (A = G.createElement(P), A.id = H, A.src = "https://connect.facebook.net/en_US/sdk.js", C.parentNode?.insertBefore(A, C));
  }(document, "script", "facebook-jssdk");
}, O = {
  method: "share",
  href: ""
}, R = (o = O) => {
  const { href: b, redirect_uri: a, hashtag: e, quote: M } = o, { id: G } = d;
  if (!G) {
    console.log("need to install first");
    return;
  }
  if (N()) {
    const P = { method: "share", href: b };
    e && (P.hashtag = "#" + e), M && (P.quote = M), window.FB?.ui?.(P, () => {
      a && window.location.replace(a);
    });
  } else {
    const P = [
      `https://www.facebook.com/dialog/share?app_id=${G}&href=${encodeURIComponent(b)}`
    ];
    a && P.push(`&redirect_uri=${encodeURIComponent(a)}`), e && P.push(`&hashtag=%23${encodeURIComponent(e)}`), M && P.push(`&quote=${encodeURIComponent(M)}`), a ? window.location.href = P.join("") : m() === "desktop" ? window.open(P[0]) : window.location.href = P.join("") + `&redirect_uri=${encodeURIComponent(h())}`;
  }
}, X = { install: p, share: R };
export {
  X as default
